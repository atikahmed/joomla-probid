...
class EverywhereController extends MyController {
    ...
    var $helpers = array('assets','routes','libraries','html','form','time','jreviews','custom_fields','rating','community','widgets');
    ...
    {                                                        
        ...
        $output = array(
            ...
            'summary'=>$Rating->overallRatings($listing,'content'),            
    ...
    function category() 
    {
        ...
        $output = $Rating->overallRatings($listing,'list');
