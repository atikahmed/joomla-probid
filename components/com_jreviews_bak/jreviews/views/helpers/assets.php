 ...
 **********************************************************************************/ 
    ...
    {     
        $assets = array(
            ...
            'css'=>array('theme','modules'/* for related listings */,'theme.detail','theme.form','paginator','jq.ui.core','jq.fancybox')
        );                     
 ...
 **********************************************************************************/   
     function CommunityListings()
     {
        ...
        $total > 0 and $assets['js'] = array('jreviews','jquery'=>'jquery','jq.scrollable');
...
//            $this->Editor->transform();
    ...
    {
        $assets = array(
            'js'=>array('jreviews','jreviews.compare','jquery','jq.ui.core','jq.ui.rating','jq.jreviews.plugins','jq.tooltip','jq.json','jq.jsoncookie'),
            'css'=>array('theme','theme.detail','paginator','jq.ui.core')
        );
