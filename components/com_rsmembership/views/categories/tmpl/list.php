...
<form action="<?php echo JRoute::_('index.php?option=com_rsmemberships&view=categories&layout=list'); ?>" method="post" name="adminForm">
...
<tr>
	<th class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>" align="right" width="5%"><?php echo JText::_('#'); ?></th>
 	<th class="sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>"><?php echo JHTML::_('grid.sort',  JText::_('RSM_TITLE'), 'm.name', $this->sortOrder, $this->sortColumn); ?></th>
</tr>
</thead>
<?php } ?>
...
<tr>
	<td align="center" colspan="2" class="sectiontablefooter<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>"><?php echo $this->pagination->getPagesLinks(); ?></td>
</tr>
<tr>
	<td colspan="2" align="right"><?php echo $this->pagination->getPagesCounter(); ?></td>
</tr>
<?php } ?>
</table>
