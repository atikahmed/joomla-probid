...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=article&tmpl=component&'.$this->what.'='.$this->id); ?>" method="post" name="adminForm" id="adminForm">
	...
	<button id="membership_save_button" type="button" onclick="if(document.adminForm.boxchecked.value==0){alert('<?php echo JText::sprintf('RSM_PLEASE_MAKE_A_SELECTION_FROM_THE_LIST_TO', JText::_('RSM_ADD')); ?>');}else{submitbutton()}"><?php echo JText::_('RSM_ADD_SELECTED_ITEMS'); ?></button>
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<?php if (RSMembershipHelper::isJ16()) { ?>
				<th><?php echo JHTML::_('grid.sort', 'Category', 'categorytitle', $this->sortOrder, $this->sortColumn); ?></th>
				<?php } else { ?>
				<th><?php echo JHTML::_('grid.sort', 'Section', 'sectiontitle', $this->sortOrder, $this->sortColumn); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'Category', 'categorytitle', $this->sortOrder, $this->sortColumn); ?></th>
				<?php } ?>
