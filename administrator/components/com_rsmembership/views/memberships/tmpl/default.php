...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=memberships'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th width="5"><?php echo JHTML::_('grid.sort', 'Id', 'm.id', $this->sortOrder, $this->sortColumn); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'RSM_MEMBERSHIP', 'm.name', $this->sortOrder, $this->sortColumn); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'RSM_CATEGORY_NAME', 'category_name', $this->sortOrder, $this->sortColumn); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'RSM_MEMBERSHIP_LENGTH', 'm.period', $this->sortOrder, $this->sortColumn); ?></th>
				<th><?php echo JHTML::_('grid.sort', 'RSM_MEMBERSHIP_PRICE', 'm.price', $this->sortOrder, $this->sortColumn); ?></th>
	...
	?>
		<tr class="row<?php echo $k; ?>">
			...
			<td><?php echo $row->category_id > 0 ? $row->category_name : '<em>'.JText::_('RSM_NO_CATEGORY').'</em>'; ?></td>
			<td>
				<?php if ($row->fixed_expiry) { ?>
					<?php echo JText::_('RSM_FIXED_EXPIRY'); ?>
				<?php } else { ?>
