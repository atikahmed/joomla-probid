	...
	function display($tpl = null)
	{
		...
		if ($task == 'edit')
		{
			...
			$type = array(
				...
				JHTML::_('select.option', 'hidden', JText::_('RSM_HIDDEN'))
			);
			$lists['type'] = JHTML::_('select.genericlist', $type, 'type', '', 'value', 'text', $row->type);
			
			$rules = array(
				JHTML::_('select.option', '', JText::_('NONE')),
				JHTML::_('select.option', 'alpha', JText::_('RSM_ALPHA')),
				JHTML::_('select.option', 'alphanumeric', JText::_('RSM_ALPHANUMERIC')),
				JHTML::_('select.option', 'numeric', JText::_('RSM_NUMERIC')),
				JHTML::_('select.option', 'email', JText::_('EMAIL')),
				JHTML::_('select.option', 'website', JText::_('RSM_WEBSITE')),
			);
			$lists['rule'] = JHTML::_('select.genericlist', $rules, 'rule', '', 'value', 'text', $row->rule);
