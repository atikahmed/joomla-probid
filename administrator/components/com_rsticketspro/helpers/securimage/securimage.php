...
class JSecurImage {
	...
	*/
	...
	function JSecurImage()
	{
		...
		$this->wordlist_file = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_rsticketspro'.DS.'helpers'.DS.'securimage'.DS.'words'.DS.'words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_rsticketspro'.DS.'helpers'.DS.'securimage'.DS.'gdfonts'.DS.'automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_rsticketspro'.DS.'helpers'.DS.'securimage'.DS.'AHGBold.ttf';
		...
		$this->signature_font  = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_rsticketspro'.DS.'helpers'.DS.'securimage'.DS.'AHGBold.ttf';

		$this->audio_path   = JPATH_ADMINISTRATOR.DS.'components'.DS.'com_rsticketspro'.DS.'helpers'.DS.'securimage'.DS.'audio'.DS;
	...
	{
		$session = JFactory::getSession();
		return $session->set('com_rsticketspro.securimage.value', '');
	}
