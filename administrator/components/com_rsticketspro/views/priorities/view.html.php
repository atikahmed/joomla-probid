...
class RSTicketsProViewPriorities extends JView
{
	function display($tpl = null)
	{
		...
		JSubMenuHelper::addEntry(JText::_('RST_PRIORITIES'), 'index.php?option=com_rsticketspro&view=priorities', true);
		...
		else
		{
			...
			$this->assignRef('priorities', $this->get('priorities'));
