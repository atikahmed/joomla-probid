...
require_once(JPATH_SITE.DS.'components'.DS.'com_rsticketspro'.DS.'views'.DS.'rsticketspro'.DS.'view.html.php');

class RSTicketsProViewTickets extends RSTicketsProViewRSTicketsPro
{
	var $_colors = array();
	...
	function display($tpl = null)
	{
		...
		JToolBarHelper::addNew('adminSubmit');
		
		$filter_word = JRequest::getVar('filter_word', '');
