...
<form id="messageForm" action="<?php echo JRoute::_('index.php?option=com_rsticketspro&view=ticketmessage'); ?>" method="post" name="messageForm">
	<table class="contentpaneopen">
		<tr>
			...
			<td nowrap="nowrap">
				...
				<?php } else { ?>
					<textarea cols="80" rows="10" class="text_area" type="text" name="message" id="message"><?php echo $this->escape($this->row->message); ?></textarea>
				<?php } ?>
			</td>
		</tr>
		<tr>
			<td width="100%" nowrap="nowrap" colspan="3">
