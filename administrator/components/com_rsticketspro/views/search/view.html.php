...
require_once(JPATH_SITE.DS.'components'.DS.'com_rsticketspro'.DS.'views'.DS.'search'.DS.'view.html.php');
...
JToolBarHelper::custom('search', 'search', 'search', JText::_('RST_SEARCH'), false);
