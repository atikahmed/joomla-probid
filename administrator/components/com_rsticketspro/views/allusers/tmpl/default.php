...
{
	window.parent.document.getElementById('user_id').innerHTML = username;
...
<form action="<?php echo JRoute::_('index.php?option=com_rsticketspro&view=allusers&controller=users'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th width="50"><?php echo JHTML::_('grid.sort', 'RST_USER_ID', 'id', $this->sortOrder, $this->sortColumn); ?></th>
	...
	?>
		<tr class="row<?php echo $k; ?>">
			...
			<td><a href="javascript: add_user('<?php echo $row->id; ?>', '<?php echo $this->escape(addslashes($row->username)); ?>');"><?php echo $this->escape($row->username); ?></a></td>
		</tr>
	<?php
		$i++;
		$k=1-$k;
