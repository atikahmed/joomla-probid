...
/**
 * View class for a list of ptslideshow.
 */
class PtslideshowViewSlideshows extends JView
{
	protected $items;
	...
	{
		require_once JPATH_COMPONENT.DS.'helpers'.DS.'ptslideshow.php';

		$state	= $this->get('State');
		$canDo	= PtslideshowHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_PTSLIDESHOW_TITLE_SLIDESHOWS'), 'slideshows.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'slideshow';
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_ptslideshow');
		}
