...
function rst_email_enable(what)
{
	if (what == 1)
	{
		$('user_email_from').disabled = true;
		$('user_email_from_addr').disabled = true;
	}
	else
	{
		$('user_email_from').disabled = false;
		$('user_email_from_addr').disabled = false;
	}
}

function rsm_enable_trial(what)
{
	var use_fixed = $('fixed_expiry0').checked;
...
function rsm_enable_gid(what)
{
	if (what == 1)
	{
		$('gid_container_1').style.display = '';
		$('gid_container_2').style.display = '';
	}
	else
	{
		$('gid_container_1').style.display = 'none';
		$('gid_container_2').style.display = 'none';
	}
}

function rsm_enable_fixed_expiry(what)
{
	var use_trial = $('use_trial_period1').checked;
	
	if (what.checked)
	{
		$('period').disabled = true;
		$('period_type').disabled = true;
		if (use_trial)
		{
			$('trial_period').disabled = true;
			$('trial_period_type').disabled = true;
		...
		$('fixed_day').disabled = false;
		$('fixed_month').disabled = false;
		$('fixed_year').disabled = false;
	}
	else
	{
		$('period').disabled = false;
		$('period_type').disabled = false;
		if (use_trial)
		{
			$('trial_period').disabled = false;
			$('trial_period_type').disabled = false;
		...
		$('fixed_day').disabled = true;
		$('fixed_month').disabled = true;
		$('fixed_year').disabled = true;
	}
}
</script>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_INFO'), 'membership-info'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_DESC'); ?>"><label for="name"><?php echo JText::_('NAME'); ?></label></span></td>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			...
			<td><input type="text" name="period" value="<?php echo $this->row->period; ?>" <?php echo $this->row->fixed_expiry ? 'disabled="disabled"' : ''; ?> id="period" maxlength="255" /> <?php echo $this->lists['period_type']; ?></td>
		</tr>
		<tr>
			...
			<td><input type="text" name="trial_period" value="<?php echo $this->row->trial_period; ?>" <?php echo !$this->row->use_trial_period || $this->row->fixed_expiry ? 'disabled="disabled"' : ''; ?> id="trial_period" maxlength="255" /> <?php echo $this->lists['trial_period_type']; ?></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_EXPIRY_DATE_DESC'); ?>"><label for="expiry_date"><?php echo JText::_('RSM_MEMBERSHIP_EXPIRY_DATE'); ?></label></span></td>
			<td><input type="checkbox" name="fixed_expiry" value="1" id="fixed_expiry0" onclick="rsm_enable_fixed_expiry(this);" <?php echo $this->row->fixed_expiry ? 'checked="checked"' : ''; ?> /> <label for="fixed_expiry0"><?php echo JText::_('RSM_MEMBERSHIP_ENABLE_FIXED_EXPIRY'); ?></label> <?php echo $this->lists['fixed_day']; ?> <?php echo $this->lists['fixed_month']; ?> <?php echo $this->lists['fixed_year']; ?></td>
		</tr>
	</table>
	</fieldset>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_STOCK_ACTIVATION'), 'membership-stock-activation'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr id="gid_container_1" <?php echo !$this->row->gid_enable ? 'style="display: none;"' : ''; ?>>
		...
		<tr id="gid_container_2" <?php echo !$this->row->gid_enable ? 'style="display: none;"' : ''; ?>>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_EMAIL_SETTINGS'), 'membership-email-settings'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_USER_EMAIL_USE_GLOBAL_DESC'); ?>"><label for="user_email_use_global"><?php echo JText::_('RSM_USER_EMAIL_USE_GLOBAL'); ?></label></span></td>
			<td><?php echo $this->lists['user_email_use_global']; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="user_email_from" value="<?php echo $this->escape($this->row->user_email_from); ?>" id="user_email_from" size="120" maxlength="255" <?php echo $this->row->user_email_use_global ? 'disabled="disabled"' : ''; ?> /></td>
		</tr>
		<tr>
			...
			<td><input type="text" name="user_email_from_addr" value="<?php echo $this->escape($this->row->user_email_from_addr); ?>" id="user_email_from_addr" size="120" maxlength="255" <?php echo $this->row->user_email_use_global ? 'disabled="disabled"' : ''; ?> /></td>
		</tr>
	</table>
<?php echo $this->tabs->endPanel(); ?>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_USER_EMAIL'), 'membership-user-email'); ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_new'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
				<?php $this->row->attachmentsPagination = isset($this->attachmentsPagination[$this->email_type]) ? $this->attachmentsPagination[$this->email_type]   : null; ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_approved'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_renew'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_upgrade'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_addextra'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
	...
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			...
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>			
			<?php if (!empty($this->row->id)) { ?>
			<?php $this->email_type = 'user_email_expire'; ?>
			<div class="button2-left"><div class="blank"><a class="modal" title="Select the path" rel="{handler: 'iframe', size: {x: 660, y: 475}}" href="<?php echo JRoute::_('index.php?option=com_rsmembership&controller=files&view=files&task=addfile&tmpl=component&membership_id='.$this->row->id.'&function=addsubscriberfiles&email_type='.$this->email_type); ?>"><?php echo JText::_('RSM_ADD_FILES'); ?></a></div></div>
			<span class="rsmembership_clear" style="margin-bottom: 10px;"></span>
			<div id="addsubscriberfiles<?php echo $this->email_type; ?>_ajax">
				<?php $this->row->attachments 			= isset($this->attachments[$this->email_type]) 			 ? $this->attachments[$this->email_type] 			 : array(); ?>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_SETTINGS'), 'membership-admin-email-settings'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL'), 'membership-admin-email'); ?>
	<?php echo $this->pane->startPane('email-pane'); ?>
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_NEW'), 'membership-admin-email-new'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_NEW_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_new_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_new_subject" value="<?php echo $this->escape($this->row->admin_email_new_subject); ?>" id="admin_email_new_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_new_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_new_text',$this->row->admin_email_new_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
	
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_APPROVED'), 'membership-admin-email-approved'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_APPROVED_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_approved_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_approved_subject" value="<?php echo $this->escape($this->row->admin_email_approved_subject); ?>" id="admin_email_approved_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_approved_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_approved_text',$this->row->admin_email_approved_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
	
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_RENEW'), 'membership-admin-email-renew'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_RENEW_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_renew_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_renew_subject" value="<?php echo $this->escape($this->row->admin_email_renew_subject); ?>" id="admin_email_renew_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_renew_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_renew_text',$this->row->admin_email_renew_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
		
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_UPGRADE'), 'membership-admin-email-upgrade'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_UPGRADE_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_upgrade_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_upgrade_subject" value="<?php echo $this->escape($this->row->admin_email_upgrade_subject); ?>" id="admin_email_upgrade_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_upgrade_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_upgrade_text',$this->row->admin_email_upgrade_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
	
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_ADDEXTRA'), 'membership-admin-email-addextra'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_ADDEXTRA_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_addextra_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_addextra_subject" value="<?php echo $this->escape($this->row->admin_email_addextra_subject); ?>" id="admin_email_addextra_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_addextra_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_addextra_text',$this->row->admin_email_addextra_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
	
	<?php echo $this->pane->startPanel(JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_EXPIRE'), 'membership-admin-email-expire'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		<tr>
			<td colspan="2"><strong><?php echo JText::_('RSM_MEMBERSHIP_ADMIN_EMAIL_EXPIRE_DESC'); ?></strong></td>
		</tr>
		<tr>
			<td width="200"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_SUBJECT_DESC'); ?>"><label for="admin_email_expire_subject"><?php echo JText::_('RSM_MEMBERSHIP_SUBJECT'); ?></label></span></td>
			<td><input type="text" name="admin_email_expire_subject" value="<?php echo $this->escape($this->row->admin_email_expire_subject); ?>" id="admin_email_expire_subject" size="120" maxlength="255" /></td>
		</tr>
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_MESSAGE_DESC'); ?>"><label for="admin_email_expire_text"><?php echo JText::_('RSM_MEMBERSHIP_MESSAGE'); ?></label></span></td>
			<td><?php echo $this->editor->display('admin_email_expire_text',$this->row->admin_email_expire_text,500,250,70,10); ?></td>
		</tr>
	</table>
	<?php echo $this->pane->endPanel(); ?>
...
<?php echo $this->tabs->startPanel(JText::_('RSM_MEMBERSHIP_ADVANCED_CUSTOMIZATION'), 'membership-advanced'); ?>
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="adminform">
		...
		<tr>
			<td width="200" valign="top"><span class="hasTip" title="<?php echo JText::_('RSM_MEMBERSHIP_CUSTOM_CODE_TRANSACTION_DESC'); ?>"><label for="custom_code_transaction"><?php echo JText::_('RSM_MEMBERSHIP_CUSTOM_CODE_TRANSACTION'); ?></label></span></td>
			<td><textarea rows="15" cols="70" name="custom_code_transaction" id="custom_code_transaction"><?php echo $this->escape($this->row->custom_code_transaction); ?></textarea></td>
		</tr>
	</table>
<?php echo $this->tabs->endPanel(); ?>
