...
<div class="col100">
	<table cellspacing="0" cellpadding="0" border="0" width="100%" class="admintable">
		...
		<tr>
			<td width="300" style="width: 300px;" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_VALIDATION_RULE_DESC'); ?>"><label for="rule"><?php echo JText::_('RSM_VALIDATION_RULE'); ?></label></span></td>
			<td><?php echo $this->lists['rule']; ?></td>
		</tr>
		<tr>
