...
<div class="col100">
	<fieldset class="adminform">
		<table class="admintable">
		<tr>
			<td width="100" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_CHECKOUT_DISPLAY_DESC'); ?>"><?php echo JText::_('RSM_CHECKOUT_DISPLAY'); ?></span></td>
			<td><?php echo $this->lists['one_page_checkout']; ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="100" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_CHOOSE_PASSWORD_DESC'); ?>"><?php echo JText::_('RSM_CHOOSE_PASSWORD'); ?></span></td>
			<td><?php echo $this->lists['choose_password']; ?></td>
		</tr>
		</table>
	</fieldset>
</div>
...
echo $this->pane->startPanel(JText::_('RSM_IDEV'), 'configuration-idev');
?>
<div class="col100">
	<fieldset class="adminform">
		<table class="admintable">
		<tr>
			<td width="100" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_IDEV_ENABLE_DESC'); ?>"><?php echo JText::_('RSM_IDEV_ENABLE'); ?></span></td>
			<td><?php echo $this->lists['idev_enable']; ?></td>
		</tr>
		<tr>
			<td width="300" style="width: 300px;" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_IDEV_URL_DESC'); ?>"><?php echo JText::_('RSM_IDEV_URL'); ?></span></td>
			<td><input class="text_area" type="text" name="idev_url" id="idev_url" <?php echo !$this->config->idev_enable ? ' disabled="disabled"' : ''; ?> size="35" value="<?php echo $this->escape($this->config->idev_url); ?>" /><button type="button" id="idev_check_url" onclick="rsm_idev_check_connection()" <?php echo !$this->config->idev_enable ? ' disabled="disabled"' : ''; ?>><?php echo JText::_('RSM_IDEV_CHECK_CONNECTION'); ?></button></td>
		</tr>
		<tr>
			<td width="100" align="right" class="key"><span class="hasTip" title="<?php echo JText::_('RSM_IDEV_TRACK_RENEWALS_DESC'); ?>"><?php echo JText::_('RSM_IDEV_TRACK_RENEWALS'); ?></span></td>
			<td><?php echo $this->lists['idev_track_renewals']; ?></td>
		</tr>
		</table>
	</fieldset>
</div>
...
function rsm_idev_enable(what)
{
	if (what == 1)
	{
		$('idev_url').disabled = false;
		$('idev_track_renewals0').disabled = false;
		$('idev_track_renewals1').disabled = false;
		$('idev_check_url').disabled = false;
	}
	else
	{
		$('idev_url').disabled = true;
		$('idev_track_renewals0').disabled = true;
		$('idev_track_renewals1').disabled = true;
		$('idev_check_url').disabled = true;
	}
}

function rsm_idev_check_connection()
{
	submitbutton('idevCheckConnection');
}
...
function submitbutton(pressbutton)
{
	...
	{
		alert('<?php echo JText::_('RSM_MEMBERSHIP_CURRENCY_ERROR', true); ?>');
		return;
	}
