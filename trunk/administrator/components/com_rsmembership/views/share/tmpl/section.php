...
<form action="<?php echo JRoute::_('index.php?option=com_rsmembership&view=share&layout=section&tmpl=component&'.$this->what.'='.$this->id); ?>" method="post" name="adminForm" id="adminForm">
