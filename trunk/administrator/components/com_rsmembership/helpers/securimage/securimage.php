...
class JSecurImage {
	...
	*/
	...
	function saveData()
	{
		...
		$session->set('com_rsmembership.securimage.ctime', RSMembershipHelper::getCurrentDate());
	}
	...
	function isCodeExpired()
	{
		...
		if (!is_numeric($this->expiry_time) || $this->expiry_time < 1)
			$expired = false;
		else if (RSMembershipHelper::getCurrentDate() - $creation_time < $this->expiry_time)
			$expired = false;
