...
<form action="<?php echo JRoute::_('index.php?option=com_rsticketspro&view=groups'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="editcell1">
		<table class="adminlist">
			...
			<tr>
				...
				<th width="20"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count($this->groups); ?>);"/></th>
				<th><?php echo JHTML::_('grid.sort', 'RST_GROUP', 'name', $this->sortOrder, $this->sortColumn); ?></th>
			</tr>
			</thead>
	<?php
	$k = 0;
	...
	?>
		<tr class="row<?php echo $k; ?>">
			...
			<td><a href="<?php echo JRoute::_('index.php?option=com_rsticketspro&controller=groups&task=edit&cid='.$row->id); ?>"><?php echo $row->name != '' ? $this->escape(JText::_($row->name)) : JText::_('RST_NO_TITLE'); ?></a></td>
		</tr>
	<?php
		$i++;
		$k=1-$k;
