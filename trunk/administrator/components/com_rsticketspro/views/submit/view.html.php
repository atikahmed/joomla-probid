...
require_once(JPATH_SITE.DS.'components'.DS.'com_rsticketspro'.DS.'views'.DS.'submit'.DS.'view.html.php');
...
JToolBarHelper::addNew('submit', JText::_('RST_SUBMIT'));
JToolBarHelper::cancel('cancelAdminSubmit');