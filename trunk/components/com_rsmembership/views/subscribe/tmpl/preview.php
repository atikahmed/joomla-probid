...
<form method="post" class="rsmembership_form" action="<?php echo JRoute::_('index.php?option=com_rsmembership&task=paymentredirect'); ?>" name="membershipForm">
...
<tr>
	<td width="30%" height="40"><?php echo JText::_('RSM_RENEWAL_PRICE'); ?>:</td>
	<td><?php echo RSMembershipHelper::getPriceFormat($total - $this->membership->price + $this->membership->renewal_price); ?></td>
</tr>
<?php } ?>
<tr>
...
<tr>
	<td width="30%" height="40"><?php echo JText::_('RSM_USERNAME'); ?>:</td>
	<?php if (!$this->logged) { ?>
...
<tr>
	<td width="30%" height="40"><?php echo JText::_('RSM_PASSWORD'); ?>:</td>
  	<td>**********</td>
</tr>
<?php } ?>
<tr>
