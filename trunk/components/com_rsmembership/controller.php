...
class RSMembershipController extends JController
{
	...
	function cancel()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_rsmembership&view=mymembership&cid='.$model->getCid(), false), JText::_('RSM_MEMBERSHIP_CANCELLED'));
	}
}
?>