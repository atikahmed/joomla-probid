...
/*                ,'joins'=>array(  # They are added in the Everywhere component when the listing is queried
    ...
    {        
        ...
        {                 
            $categories = $this->Category->getCategoryList(array('disabled'=>true,'type_id'=>array(0,$listing['Criteria']['criteria_id'])));
        }	
    ...
    **/
    ...
    {            
        ...
        {           
            $categories = $this->Category->getCategoryList(array('parent_id'=>$cat_id,'indent'=>false,'disabled'=>false));
            if(!empty($categories))
            {
