...
class CommunityModel extends MyModel  {
    ...
    {                
        ...
        $avatar and $conditions[] = 'Community.thumb <> "components/com_community/assets/default_thumb.jpg" AND Community.thumb <> "components/com_community/assets/user_thumb.png"';
    ...
    function addProfileInfo($results, $modelName, $userKey)
    {
        ...
        foreach ($profiles AS $key=>$value) {    
            ...
            $profiles[$value[$this->name][$userKey]][$this->name]['avatar_path'] = WWW_ROOT. $thumb;
        }
