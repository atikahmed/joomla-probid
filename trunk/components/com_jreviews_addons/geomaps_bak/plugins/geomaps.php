...
************************************************************************/    
    ...
    */
    ...
    {                
        ...
        {
            case 'com_content':
                $this->c->assets['head']['googlemaps'] = '<script src="'.Sanitize::getString($this->c->Config,'geomaps.google_url','http://maps.google.com').'/maps?file=api&amp;v=2&amp;sensor=false&amp;key='.Sanitize::getString($this->c->Config,'geomaps.google_key').'" type="text/javascript"></script>';
            ...
            case 'categories':
                $this->c->assets['head']['googlemaps'] = '<script src="'.Sanitize::getString($this->c->Config,'geomaps.google_url','http://maps.google.com').'/maps?file=api&amp;v=2&amp;sensor=false&amp;key='.Sanitize::getString($this->c->Config,'geomaps.google_key').'" type="text/javascript"></script>';
                $this->c->assets['css'][] = 'geomaps';
                $this->c->assets['js'] = array('jquery','geomaps');
            break;
        }
    } 
