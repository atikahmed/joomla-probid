...
<?php } ?>
	...
	<h1><?php echo JText::_('RST_SUBMIT_TICKET'); ?></h1>
<div class="rst_message">	
...
<table class="contentpaneopen rst_submit_form">
	...
	<?php } else { ?>
		...
		<tr>
			<td><label for="submit_email"><span class="hasTip" title="<?php echo JText::_('RST_CUSTOMER_EMAIL_DESC'); ?>"><?php echo JText::_('RST_YOUR_EMAIL'); ?></span></label></td>
			<td>
		...
		<tr>
			<td><label for="submit_name"><span class="hasTip" title="<?php echo JText::_('RST_CUSTOMER_NAME_DESC'); ?>"><?php echo JText::_('RST_YOUR_NAME'); ?></span></label></td>
