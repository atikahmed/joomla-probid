...
<td width="30%" height="40"><?php echo JText::_('RSM_STATUS'); ?>:</td>
	...
	<?php if ($this->membership->status == 0) { ?>
		<a onclick="return confirm('<?php echo JText::_('RSM_CONFIRM_CANCEL'); ?>')" href="<?php echo JRoute::_('index.php?option=com_rsmembership&task=cancel&cid='.$this->membership->id); ?>"><?php echo JText::_('Cancel Service'); ?></a>
	<?php } ?>
	</td>
</tr>
<?php } ?>
