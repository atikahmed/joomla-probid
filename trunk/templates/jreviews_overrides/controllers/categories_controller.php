...
//                $conditions[] = 'Section.access <= ' . $this->Access->getAccessId();
        ...
        *******************************************************************/
        ...
        switch($action) 
        {
			...
			//BEGIN Replaced using same code as 'custom' by FDS 3/6/2012
			case 'mylistings':
                $menuParams = $this->Menu->getMenuParams($menu_id); 
                $page['top_description'] = Sanitize::getString($menuParams,'custom_description');
                $page['top_description'] = str_replace('\n','',$page['top_description']);
                ...
                break;
				//END Replaced using same code as 'custom' by FDS 3/6/2012
			
			//BEGIN COMMENTED OUT BY FDS 3/6/2012
            //case 'mylistings':
            //    if($user_id > 0) 
            //    {
            ...
            //    break;
				//END COMMENTED OUT BY FDS 3/6/2012        
    ...
    function custom() {
		...
		/* FDS This line added for ability to filter for the logged-in user */
